...
var file_service_proto_rawDesc = []byte{
	...
	0x74, 0x32, 0x3e, 0x0a, 0x0f, 0x50, 0x72, 0x6f, 0x64, 0x75, 0x63, 0x65, 0x72, 0x53, 0x65, 0x72,
	0x76, 0x69, 0x63, 0x65, 0x12, 0x2b, 0x0a, 0x08, 0x50, 0x72, 0x6f, 0x64, 0x75, 0x63, 0x65, 0x72,
...
var file_service_proto_depIdxs = []int32{
	0, // 0: proto.ProducerService.Producer:input_type -> proto.Request
	1, // 1: proto.ProducerService.Producer:output_type -> proto.Response
...
type ProducerServiceClient interface {
	Producer(ctx context.Context, in *Request, opts ...grpc.CallOption) (*Response, error)
}
...
func (c *producerServiceClient) Producer(ctx context.Context, in *Request, opts ...grpc.CallOption) (*Response, error) {
	out := new(Response)
	err := c.cc.Invoke(ctx, "/proto.ProducerService/Producer", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ProducerServiceServer interface {
	Producer(context.Context, *Request) (*Response, error)
}
...
func (*UnimplementedProducerServiceServer) Producer(context.Context, *Request) (*Response, error) {
...
func _ProducerService_Producer_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(Request)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ProducerServiceServer).Producer(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.ProducerService/Producer",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ProducerServiceServer).Producer(ctx, req.(*Request))
	}
...
var _ProducerService_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "Producer",
			Handler:    _ProducerService_Producer_Handler,
		},
	},
